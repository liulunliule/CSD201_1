...
//    }
    ...
    void insert(String xName, double xPrice, int xColor) {
        ...
        if (root == null) {
                root = new Node(new Laptop(xName, xPrice, xColor));
                return;
            }
            Node f, p;
            p = root;
            ...
            if (xPrice < f.getInfo().price) {
                f.left = new Node(new Laptop(xName, xPrice, xColor));
            } else {
                f.right = new Node(new Laptop(xName, xPrice, xColor));
            }
