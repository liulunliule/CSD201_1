...
public class Graph {
    ...
    void f1() throws Exception {
         ...
         * ONLY display the vertex right after D up to the next 4 vertices, and NOT display vertex 'C' (if any, index = 2), but still consider it as one count during traversing the graph.
    ...
    void f2() throws Exception {
         ...
         * Starting from the vertex A (index = 0). 
